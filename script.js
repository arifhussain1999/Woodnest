        (function () {
            ...
            function createProductCard(product) {
              ...
              <div class="product-card-image">
                <div class="img-placeholder"><img src="${product.images ? product.images[0] : product.image}" alt="${product.name}" loading="lazy"></div>
              ...
              <div class="product-card-info">
                ...
                <div class="product-card-colors">
                  <span class="color-dot" style="background:${product.color === 'brown' ? '#8B5E3C' : product.color === 'black' ? '#3A3A3A' : product.color === 'beige' ? '#D6C8B8' : '#C49A6C'};"></span>
                </div>
                <button class="inquiry-btn" onclick="event.stopPropagation(); window.open('https://wa.me/919933447711?text=' + encodeURIComponent('Hello WoodNest, I am interested in the ${product.name}. Could you provide more details?'), '_blank')">Inquiry</button>
              </div>`;
                // 3D tilt
...
<footer>
    ...
    <p style="font-size:0.8rem;color:#888;">
        © 2026 WoodNest. All rights reserved. | Luxury Wooden Sofas
    </p>

    <p style="font-size:1.1rem;color:#999;margin-top:1rem;">
        Crafted with 🤎 by 
        <a href="https://www.nexvoraweb.in" target="_blank"
            style="color:var(--maroon);text-decoration:none;font-weight:700;">
            NexvoraWeb
        </a>
    </p>
</footer>
